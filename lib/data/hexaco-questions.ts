...
> = {
  H: {
    name: "诚实-谦逊",
    fullName: "Honesty-Humility",
    icon: "🤝",
    description: `对于利用别人、获取财富或特权的欲望。`,
    high: `你对利用他人获取个人利益的行为有很强的抵触力。即使有机会获取额外的好处，你也倾向于选择正当手段。这使你在团队中是一个可信赖的人，但也需要注意不要过度厌恶"推销"或"营销"性质的职业行为，因为你可能会觉得那是一种"利用"别人。`,
    low: `你可能觉得在适当的时机为自己争取利益是理所当然的。这种实用主义的态度能帮你在竞争激烈的环境中快速做出决策，但可能让人觉得你缺乏情感上的共鸣。这不代表你"不道德"，只是你对"利益"的定义更宽。`,
    medium: `你在诚实与实用之间保持着平衡。你不会主动利用别人，但也不会因为一点小利而过度自责。这是大多数人在日常生活中的常态。`,
  },
  E: {
    name: "情绪性",
    fullName: "Emotionality",
    icon: "🌊",
    description: `对压力、恐惧和依赖的敏感度。`,
    high: `你对周围的情绪波动和潜在危险非常敏感。这让你很容易与他人产生共情，也能提前感知到问题。但也可能让你在压力下更容易感到疲惫或焦虑。你的情绪是丰富的——这是一种力量，只需要学会管理它。`,
    low: `你在面对压力时表现得比较冷静和淡定。即使在应急情况下，你也能保持清晰的头脑。这是很强大的应对资源，但有时你周围的人可能觉得你“不太在乎"——其实只是你的情绪波动幅度比较小。`,
    medium: `你的情绪响应模式比较平稳。你不会轻易被小事打扰，但在真正重要的事情上也能产生适当的情绪反应。这是一种健康的适应性。`,
  },
  X: {
    name: "外向性",
    fullName: "Extraversion",
    icon: "✨",
    description: `对社交互动和活力的偏好。`,
    high: `你从与人交往中获取能量。你喜欢成为活动的中心，也容易与陌生人建立联系。这种特质让你在需要沟通或领导的场合非常有优势，但需要注意保留独处的时间，避免因过度社交而耗尽。`,
    low: `你更倾向于小范围的深度交流，而不是大型社交场合。独处对你来说是重要的充电方式。这种内向的特质让你在需要专注和反思的工作中表现出色，只是有时你需要主动推自己走出舒适区。`,
    medium: `你在社交与独处之间能够灵活切换。你既享受与人交流的时光，也需要一些独处来恢复精力。这种平衡是很多人的理想状态。`,
  },
  A: {
    name: "宜人性",
    fullName: "Agreeableness",
    icon: "🌱",
    description: `对于他人需求和感受的理解与调适。`,
    high: `你天生倾向于调解冲突，尝试理解别人的立场。你很容易原谅他人的过错，也不喜欢起争执。这种温和是你的强项，但要注意不要过度委屈自己的需求来换取和平。`,
    low: `你说话直接，不太会因为顾虑别人的感受而改变自己的观点。这让你在需要快速决策或进行关键对话时很有效率，但可能会让人觉得你有点"冷淡"。这不是缺点，只是一种与众不同的交互风格。`,
    medium: `你能够在坚持原则与体谅他人之间找到平衡。你不会轻易被别人利用，但也不会因为一点小事就与人产生矛盾。这种特质让你在各种团体中都能舒适地自处。`,
  },
  C: {
    name: "尽责性",
    fullName: "Conscientiousness",
    icon: "🎯",
    description: `对组织、努力和认真的追求。`,
    high: `你对工作和责任有很高的标准。你习惯于做计划、跟踪进度，并确保任务按时完成。这种可靠性是团队和组织中的重要资产，但要注意不要因为过度完美主义而耗费太多精力在细节上。`,
    low: `你更倾向于灵活应对，而不是严格按照计划行事。你可能觉得严格的结构会限制你的创造力。这种特质让你在需要快速调整方向的环境中表现出色，但可能需要一些外部结构来帮助你完成长期目标。`,
    medium: `你既有计划性也有灵活性。你会为重要的事情做好准备，但也不会因为一点偏差就感到焦虑。这种平衡让你能够在多种环境下适应良好。`,
  },
  O: {
    name: "开放性",
    fullName: "Openness to Experience",
    icon: "🎨",
    description: `对新想法、创意和新体验的好奇心。`,
    high: `你对新体验、艺术和抽象思维有很强的好奇心。你喜欢探索不同的视角，也不介意走与众不同的路。这种创造力是你的核心优势，但有时你可能需要注意不要因为"太多想法"而难以执行。`,
    low: `你更倾向于实际和已知的事物。你喜欢有明确答案的任务，也不太会被"天马行空"的想法所吸引。这种实干的态度让你在需要稳定性的工作中表现出色，只是有时你可能会错过一些有趣的新机会。`,
    medium: `你既享受熟悉的事物，也愿意尝试适度的新体验。你不是那种一探究竟的人，但也不会拒绝所有变化。这种平衡让你能够在安全与新鲜之间找到平衡。`,
  },
};
